const InputEntrar = () => {
  return (
    <div className="flex items-center bg-[#292524] rounded-full w-fit h-[45px] p-2">
      ...
      <svg
        className="w-[35px] fill-white ml-2 transition-transform duration-300"
      ...
      <button className="bg-white text-black font-medium h-full w-[95px] rounded-xl flex items-center justify-center relative overflow-hidden transition-all duration-300 hover:text-white hover:bg-[#FF7837]">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="30"
          height="10"
          viewBox="0 0 38 15"
          className="absolute right-[150px] transition-all duration-300 hover:right-0"
        >
